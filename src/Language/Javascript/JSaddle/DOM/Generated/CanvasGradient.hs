...
module Language.Javascript.JSaddle.DOM.Generated.CanvasGradient
       (addColorStop, CanvasGradient, castToCanvasGradient,
        gTypeCanvasGradient)
       where
...
addColorStop self offset color
  = liftDOM
      (void (self ^. jsf "addColorStop" [toJSVal offset, toJSVal color]))