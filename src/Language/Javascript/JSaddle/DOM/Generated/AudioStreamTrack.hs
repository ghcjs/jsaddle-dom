...
module Language.Javascript.JSaddle.DOM.Generated.AudioStreamTrack
...
newAudioStreamTrack ::
                    (MonadDOM m, IsDictionary audioConstraints) =>
                      Maybe audioConstraints -> m AudioStreamTrack
newAudioStreamTrack audioConstraints
  = liftDOM
      (AudioStreamTrack <$>
         new (jsg "AudioStreamTrack") [toJSVal audioConstraints])