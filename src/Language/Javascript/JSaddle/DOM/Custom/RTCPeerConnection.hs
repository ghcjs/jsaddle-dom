module Language.Javascript.JSaddle.DOM.Custom.RTCPeerConnection (
    module Generated
  , createOffer'
  , createOffer
  , createAnswer'
...
import Language.Javascript.JSaddle.DOM.Custom.DOMError (throwDOMErrorException)

import Language.Javascript.JSaddle.DOM.Generated.RTCSessionDescriptionCallback
       (newRTCSessionDescriptionCallback)
import Language.Javascript.JSaddle.DOM.Generated.RTCPeerConnectionErrorCallback
       (newRTCPeerConnectionErrorCallback)
import Language.Javascript.JSaddle.DOM.Generated.VoidCallback
       (newVoidCallback)
import Language.Javascript.JSaddle.DOM.Generated.RTCStatsCallback
       (newRTCStatsCallback)

import Language.Javascript.JSaddle.DOM.Generated.Geolocation as Generated hiding (getCurrentPosition)
import qualified
       Language.Javascript.JSaddle.DOM.Generated.RTCPeerConnection
       as Generated
