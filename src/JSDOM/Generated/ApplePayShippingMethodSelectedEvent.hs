...
module JSDOM.Generated.ApplePayShippingMethodSelectedEvent
       (getShippingMethod, ApplePayShippingMethodSelectedEvent(..),
...
getShippingMethod self
  = liftDOM ((self ^. js "shippingMethod") >>= fromJSValUnchecked)
