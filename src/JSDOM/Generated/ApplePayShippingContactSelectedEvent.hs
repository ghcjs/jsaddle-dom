...
module JSDOM.Generated.ApplePayShippingContactSelectedEvent
       (getShippingContact, ApplePayShippingContactSelectedEvent(..),
...
getShippingContact self
  = liftDOM ((self ^. js "shippingContact") >>= fromJSValUnchecked)
